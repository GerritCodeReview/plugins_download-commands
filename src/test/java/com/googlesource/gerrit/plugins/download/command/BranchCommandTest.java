...
public class BranchCommandTest extends DownloadCommandTest {
  ...
  public void buildBranchCommand() {
    BranchCommand checkoutCommand = newBranchCommand(defaultGerritConfig());
  ...
  @Test
  public void buildBranchCommandWithRecursiveCheckout() {
    Config cfg = defaultGerritConfig();
    cfg.setBoolean("download", null, "recursiveCheckout", true);
    BranchCommand checkoutCommand = newBranchCommand(cfg);
